...
Tags: Intelichat, chat, bot, chatbot, messenger, facebook
...
An easy and simple way to add <b>Intelichat</b> MESSENGER chatbots to your Wordpress. This plugin enables direct configuration of a chatbot to be launched from a messenger button in your wordpress website. <b>Intelichat</b> is a platform to easily create chatbots without programming.
...
2. This is the plugin configuration where you can set the appearance of your Messenger button. 
3. This is a list of chatbots available that can be inserted into your website.
4. This is an example of a wordpress website using a Messenger button enabled by this plugin.
